  ...
  return <div className="flex justify-between sm-mx:flex-wrap">
        <div className="flex gap-2 items-center">
            ...
            <div className="flex flex-col">
                ...
                <div className="text-sm sm-mx:text-xs text-mine-shaft-300">{props.issuer}</div>
            </div>
        </div>
        <div className="flex gap-2 ">
            <div className="flex flex-col items-end sm-mx:flex-row sm-mx:gap-2">
                <div className="text-sm sm-mx:text-xs text-mine-shaft-300">{formatDate(props.issueDate)}</div>
