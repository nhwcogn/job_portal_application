...
const Companies = () => {
    return <div className="mt-20 pb-5">
        <div className="text-4xl md-ms:text-3xl sm-mx:text-2xl xs-mx:text-xl text-center font-semibold mb-10 text-mine-shaft-100">Trust By <span className="text-bright-sun-400">1000+</span> Companies</div>
