...
const Testimonials = () => {
    return <div className="mt-20 pb-5 p-5">
        <div className="text-4xl md-ms:text-3xl sm-mx:text-2xl xs-mx:text-xl text-center font-semibold mb-3 text-mine-shaft-100">What <span className="text-bright-sun-400">User</span> says about us?</div>
        <div className="flex justify-evenly gap-5 md-mx:flex-wrap mt-10">
        {
            ...
            <div className="flex gap-2 items-center">
                <Avatar className="!h-14 !w-14" src="avatar1.png" alt="User 1" />
                <div>
