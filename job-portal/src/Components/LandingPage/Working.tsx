...
const Working = () => {
    return <div className="mt-20 pb-5">
        <div className="text-4xl md-ms:text-3xl sm-mx:text-2xl xs-mx:text-xl text-center font-semibold mb-3 text-mine-shaft-100">How it <span className="text-bright-sun-400">Works</span></div>
        ...
        <div className="flex px-16 bs-mx:px-10 md-mx:flex-col md-mx:px-5 gap-2 justify-between items-center">
            <div className="relative">
                ...
                <div className="w-36 xs-mx:w-28 flex top-[15%] right-0 absolute flex-col items-center gap-1 border border-bright-sun-400 rounded-xl py-3 px-1 backdrop-blur-md">
                    <Avatar className="!h-16 !w-16 xs-mx:!h-12 xs-mx:!w-12" src="avatar4.png" alt="it's me" />
