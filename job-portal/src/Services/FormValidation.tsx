const signupValidation = (name:string, value:string)=>{
    switch(name){
        ...
        case "password":
            ...
            if(!/^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[!@#$%^&*])[A-Za-z\d!@#$%^&*]{8,15}$/.test(value)) return "Password must be 8-15 characters with an uppercase letter, a lowercase letter, a number and a special character.";
            return "";
        default:
            return "";
    }
